...
class RebaseAPI:
  ...
  def get_hornsea_dwd(self):
    ...
    variables = 'WindSpeed, WindSpeed:100, WindDirection, WindDirection:100, Temperature, RelativeHumidity, PressureReducedMSL, TotalPrecipitation'
  ...
  def get_pes10_nwp(self,model):
    ...
    variables = 'SolarDownwardRadiation, TotalPrecipitation, CloudCover, Temperature, PressureReducedMSL'
